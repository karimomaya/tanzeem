...
public interface CategoryRepository extends JpaRepository<Category, Long> {
    ...
    @Query("SELECT c FROM Category c WHERE c.id = :categoryId AND c.tenantId = :tenantId")
    Optional<Category> findByCategoryIdAndTenantIdWithProducts(@Param("categoryId") Long categoryId, @Param("tenantId") String tenantId);


    // For cases where you don't need products loaded
    @Query("SELECT c FROM Category c WHERE c.id = :categoryId AND c.tenantId = :tenantId")
    Optional<Category> findByCategoryIdAndTenantId(@Param("categoryId") Long categoryId, @Param("tenantId") String tenantId);
