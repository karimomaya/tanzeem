<template>
    <div class="grid-container">
        ...
        <v-row v-else>
            ...
            >
                <v-card
                    class="card-base grid-card product-card-hover"
                    elevation="0"
                ...
                >
                                ...
                                <div class="quick-actions">
                                    <v-menu>
                                        ...
                                        <v-list density="compact" class="actions-menu">
                                            ...
                                            <v-list-item @click="$emit('delete', product)" class="action-item action-danger">
                                                <template v-slot:prepend>
                    ...
                    <v-card-text class="content">
                        ...
                        <div class="product-price-section">
                            <div class="product-price-main product-price-main-grid">{{ formatPrice(product.price) }} ر.س</div>
                        ...
                        <div class="stock-section">
                            <div class="stock-info">
                                <div class="product-stock-indicator" :class="`product-stock-${getStockLevel(product.stock, product.minimumStock)}`">
                                    <div class="product-stock-dot"></div>
                                    <span class="product-stock-text">{{ getStockText(product.stock, product.minimumStock) }}</span>
                                </div>
