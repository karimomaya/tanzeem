<template>
    <BaseModal :model-value="modelValue" @update:model-value="$emit('update:modelValue', $event)"
        icon="mdi-tag-multiple" :title="editedCategoryId ? 'تعديل التصنيف' : 'إضافة تصنيف جديد'"
        ...
        :primary-icon="editedCategoryId ? 'mdi-content-save' : 'mdi-plus'" :loading="loading"
        :primary-disabled="loading" @close="closeDialog" @save="saveCategory">
                ...
                <v-row>
                    ...
                    <v-col cols="12" md="6">
                        <div class="form-group">
                            ...
                            <v-text-field v-model="editedCategory.name" :rules="fieldValidations.required('التصنيف')"
                                variant="outlined" density="comfortable" placeholder="أدخل اسم التصنيف"
                    ...
                    <v-col cols="12" md="6">
                        <div class="form-group">
                            ...
                            <v-color-picker style="background: transparent;" v-model="editedCategory.color" mode="hexa"
                                hide-canvas hide-inputs :swatches="colorSwatches"
                    ...
                    <v-col cols="12">
                        <div class="form-group">
                            ...
                            <v-textarea v-model="editedCategory.description" variant="outlined" density="comfortable"
                                placeholder="أدخل وصف التصنيف..." rows="3" hide-details="auto"
