...
VALUES
( '2024-01-01', 1, 'INV-001', 1000.00, 'شراء فاتورة أولى', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
...
( '2024-01-04', 4, 'INV-004', 600.00, 'شراء خامس', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-05', 5, 'INV-005', 920.00, 'شراء سادس', 'tanzeem', 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-06', 6, 'INV-006', 100.00, 'شراء سابع', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-07', 7, 'INV-007', 1150.00, 'شراء ثامن', 'tanzeem', 'CANCELLED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-08', 8, 'INV-008', 730.00, 'شراء تاسع', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-09', 9, 'INV-009', 660.00, 'شراء عاشر', 'tanzeem', 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-10', 10, 'INV-010', 200.00, 'شراء إضافي', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-11', 11, 'INV-011', 1240.00, 'شراء عادي', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-12', 12, 'INV-012', 990.00, 'طلب سريع', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-13', 13, 'INV-013', 115.00, 'طلب تجريبي', 'tanzeem', 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-14', 14, 'INV-014', 1800.00, 'شراء خاص', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-15', 15, 'INV-015', 500.00, 'شراء داخلي', 'tanzeem', 'CANCELLED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
( '2024-01-16', 16, 'INV-016', 750.00, 'شراء خارجي', 'tanzeem', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin'),
